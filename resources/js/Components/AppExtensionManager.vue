...
/** Өргөтгөл суугаагүй — анхааруулга. */
...
<template>
    ...
    <section v-else-if="! props.notifyOnly" class="space-y-3 sm:space-y-4">
        ...
        <div class="px-0.5">
            <h3 class="text-base font-semibold text-slate-800">Өргөтгөл</h3>
            <p class="mt-0.5 text-xs text-slate-500 sm:text-sm">
                Утсаар системд хөтчөөр орно. Компьютер дээр Chrome/Edge өргөтгөлөөр автомат нэвтрэлт идэвхжүүлнэ.
            </p>
        </div>
        ...
        <div class="overflow-hidden rounded-2xl border border-brand-navy-300 bg-brand-navy-50/50 ring-1 ring-brand-navy-200/80">
