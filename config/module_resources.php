...
return [
    ...
    'regulations' => [
        ...
        'title' => 'Дотоод журам',
        'description' => 'Журмыг Word эсвэл PDF-ээр оруулж, табаар үзнэ. PDF шууд хуудсан дээр нээгдэнэ.',
        ...
        'fields' => [
            ...
            ['name' => 'file', 'label' => 'Файл (PDF, Word)', 'type' => 'file', 'required' => true, 'accept' => '.pdf,.doc,.docx,application/pdf'],
            ['name' => 'published_at', 'label' => 'Нийтэлсэн огноо', 'type' => 'date'],
        ],
        'defaults' => [],
