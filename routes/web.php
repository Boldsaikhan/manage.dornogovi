...
Route::middleware('auth')->group(function () {
    ...
    Route::patch('/phone-directory/group', [PhoneDirectoryController::class, 'renameGroup'])->name('phone-directory.group');
    ...
    Route::get('/modules/leaves/logs', [LeaveController::class, 'logs'])->name('leaves.logs');
    ...
    Route::get('/modules/{module}/logs', [ModuleResourceController::class, 'logs'])
        ->name('modules.logs');
    ...
    Route::middleware('admin')->prefix('admin')->name('admin.')->group(function () {
        ...
        Route::patch('/users/{user}/login', [UserAccessController::class, 'syncLogin'])->name('users.login');
        Route::post('/users/sync-logins', [UserAccessController::class, 'syncAllLogins'])->name('users.sync-logins');
