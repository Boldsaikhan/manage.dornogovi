...
### Одоогийн байдал (2026-09-04, энэ компьютерээс хэмжсэн)

> **Ахиц гарсан.** 08-30-нд Univision ч NXDOMAIN байсан бол одоо зөв болжээ —
> өмнөх хүсэлт үр дүнгээ өгсөн байна. **Skytel дээр л үлдсэн.**

| DNS | Үр дүн |
|---|---|
| `8.8.8.8` (Google) | A → `202.37.109.67` **OK** |
| `1.1.1.1` (Cloudflare) | A → `202.37.109.67` **OK** |
| `59.153.112.2` (Univision) | A → `202.37.109.67` **OK** ← зассан |
| `103.206.153.188` (Skytel) | **NXDOMAIN** ← үлдсэн асуудал |
| `202.179.0.10` (MobiCom) | хариу ирсэнгүй (энэ сүлжээнээс хүрэхгүй) |
| Сайт өөрөө | `https://manage.dornogovi.gov.mn/login` → **200** |

Бүсийн SOA: `minimum TTL = 86400` — сөрөг (NXDOMAIN) кэш **24 цаг** барина.
Тиймээс authoritative серверүүдийн аль нэг нь зөрж байвал ISP-ийн кэш өдөр
тутам дахин хордоно. Дэлгэрэнгүй, илгээх захиа:
[dns-request-ndc-2026-09-04.md](dns-request-ndc-2026-09-04.md)

### Архив — 2026-08-30-ны хэмжилт
