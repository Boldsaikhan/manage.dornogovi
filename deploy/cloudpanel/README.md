...
## Хамгийн хялбар — нэг команд

Дараах нэг мөр бүх зүйлийг хийнэ: нөөцлөх, хуучин стек устгах, CloudPanel суулгах,
**админ хэрэглэгч / сайт / өгөгдлийн санг `clpctl`-ээр үүсгэх**, өгөгдөл сэргээх,
cron сэргээх. Эцэст нь бүх нууц үгийг хэвлэнэ.

```bash
sudo bash /opt/manage-dornogovi/deploy/cloudpanel/install-all.sh
```

Ганц асуулт: snapshot авсан эсэх (`ТИЙМ` гэж бичнэ). Дараа нь 20-40 минут өөрөө ажиллана.

Дуусахад дэлгэц дээр CloudPanel-ийн хаяг, нэвтрэх нэр, нууц үг гарна —
**тэр даруй хадгалж авна уу**. `/root/.cloudpanel_secrets` дотор ч бичигдэнэ.

> Суулгагчийн SHA256-г хатуу шалгуулах бол:
> `sudo EXPECTED_SHA256=<албан ёсны hash> bash .../install-all.sh`
> Hash-ыг [CloudPanel-ийн баримтаас](https://www.cloudpanel.io/docs/v2/getting-started/debian/) авна.

---

Доорх 3 алхам нь ижил ажлыг **гараар, хэсэгчлэн** хийх хувилбар — асуудал гарвал
аль алхамд гацсаныг тодруулахад хэрэгтэй.
